...
public abstract class APITestBase {
    ...
    public String getPayload(String filename) {
        String path = System.getProperty("user.dir") + "/payloads/" + filename + ".json";
    ...
    protected void JSON(String content) {
        TestListener.getTestCaseSection().info(MarkupHelper.createCodeBlock(content, CodeLanguage.JSON));
    }
}
